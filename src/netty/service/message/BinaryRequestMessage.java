 ...
 */
public class BinaryRequestMessage {
	private byte encode;// 数据编码格式。已定义：0：UTF-8，1：GBK，2：GB2312，3：ISO8859-
	...
	public BinaryRequestMessage(){}
	public BinaryRequestMessage(int command){
	...
	public String toString() {
		return "BinaryRequest [encode=" + encode + ", encrypt=" + encrypt
				+ ", extend1=" + extend1 + ", extend2=" + extend2
				+ ", sessionid=" + sessionid + ", command=" + command
				+ ", length=" + length + ", values=" + values + ", ip=" + ip
				+ "]";
	}
}